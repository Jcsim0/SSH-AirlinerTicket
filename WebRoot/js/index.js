 ...
 */
function check(){
	if( checkStartCity ()&&checkArriveCity ()&&checkStartDate()){
		return true;
	}else{
		if(!checkStartCity()) checkStartCity();
		else 
			if(!checkArriveCity()) checkArriveCity();
		else  checkStartDate();
		return false;
	}
}
 ...
 * 校验到达城市
 */
function checkArriveCity (){
	var arriveCity=$("#getcity_name").val();
	if(arriveCity==''||arriveCity=="中文/拼音"){
		$.Huimodalalert('目的城市不能为空',2000);
		return false;
	}else{
		return true;
	}
...
/*我的信息-查看*/
function showMyMsg(isLogin,title,url,w,h){
	if(isLogin.length<1){
...
function checkFlightName(){
	if($("#flightName").val()!=''){
		...
		$.Huimodalalert('航班名不能为空',1000);
		return false;
	}
}
function checkStartDate2(){
			...
			getPath:function(){
				var e=document.currentScript?document.currentScript.src:function(){
					...
					getStyle:function(e,t){
						...
						n={v:"5.0.9",config:{},index:window.laydate&&window.laydate.v?1e5:0,path:t.getPath,set:function(e){
							var t=this;
														...
														w.elem=function(e,t){
															...
															C.addStr=function(e,t){
																...
																w.each(t,function(t,n){
																	new RegExp("\\b"+n+"\\b").test(e)||(e=e+" "+n)}),e.replace(/^\s|\s$/,"")
																	},
																		...
																		return e=e.replace(/\s+/," "),t=t.replace(/\s+/," ").split(" "),w.each(t,function(t,n){
																			...
																			C.prototype.find=function(e){
																				var t=this,n=0,a=[],i="object"==typeof e;return this.each(function(r,o){for(var s=i?[e]:o.querySelectorAll(e||null);n<s.length;n++)a.push(s[n]);t.shift()}),i||(t.selector=(t.selector?t.selector+" ":"")+e),w.each(a,function(e,n){t.push(n)}),t},C.prototype.each=function(e){return w.each.call(this,this,e)},C.prototype.addClass=function(e,t){return this.each(function(n,a){a.className=C[t?"removeStr":"addStr"](a.className,e)})},C.prototype.removeClass=function(e){return this.addClass(e,!0)},C.prototype.hasClass=function(e){var t=!1;return this.each(function(n,a){new RegExp("\\b"+e+"\\b").test(a.className)&&(t=!0)}),t},C.prototype.attr=function(e,t){var n=this;return void 0===t?function(){if(n.length>0)return n[0].getAttribute(e)}():n.each(function(n,a){a.setAttribute(e,t)})},C.prototype.removeAttr=function(e){return this.each(function(t,n){n.removeAttribute(e)})},C.prototype.html=function(e){return this.each(function(t,n){n.innerHTML=e})},C.prototype.val=function(e){return this.each(function(t,n){n.value=e})},C.prototype.append=function(e){return this.each(function(t,n){"object"==typeof e?n.appendChild(e):n.innerHTML=n.innerHTML+e})},C.prototype.remove=function(e){return this.each(function(t,n){e?n.removeChild(e):n.parentNode.removeChild(n)})},C.prototype.on=function(e,t){return this.each(function(n,a){a.attachEvent?a.attachEvent("on"+e,function(e){e.target=e.srcElement,t.call(a,e)}):a.addEventListener(e,t,!1)})},C.prototype.off=function(e,t){return this.each(function(n,a){a.detachEvent?a.detachEvent("on"+e,t):a.removeEventListener(e,t,!1)})},T.isLeapYear=function(e){return e%4===0&&e%100!==0||e%400===0},T.prototype.config={
																						...
																						position:null,
																						calendar:!1,mark:{},
																						zIndex:null,done:null,change:null
																						},

	...
	<div class="page-container">
		...
		<div class="mt-20">
			<table class="table table-border table-bordered table-bg table-hover table-sort table-responsive">
				...
				<tbody>
					<s:if test="#session.all_flightInfoList!=null">
						<s:iterator value="#session.all_flightInfoList" var="flightInfo" status="st">
							<tr class="text-c">
								...
								<s:if test="#flightInfo.flightState=='未起飞'">
									...
									<td class="f-14 td-manage">
										...
										<a style="text-decoration:none;display:none;" id="submitt" onclick="submitFlight(this,'<s:property value="#flightInfo.flightId"/>');" href="javascript:;" title="提交"><i class="Hui-iconfont">&#xe632;</i></a>  
										
										<a style="text-decoration:none;" id="flying" onclick="flight_flying(this,'<s:property value="#flightInfo.flightId"/>')" href="javascript:;" title="航班起飞"><i class="Hui-iconfont">&#xe603;</i></a>
										
										<a style="text-decoration:none" class="ml-5" id="cancelFlight" onClick="flight_cancel(this,'<s:property value="#flightInfo.flightId"/>')" href="javascript:;" title="取消航班任务"><i class="Hui-iconfont">&#xe6de;</i></a>
										
										<a style="text-decoration:none;display:none;" id="fly" onclick="flight_readyFly(this,'<s:property value="#flightInfo.flightId"/>')" href="javascript:;" title="重新发布"><i class="Hui-iconfont">&#xe642;</i></a>
										
									</td>
								</s:if>
								
								<s:elseif test="#flightInfo.flightState=='已起飞'">
									<td class="td-status">
								...
								<s:elseif test="#flightInfo.flightState=='已取消'">
									<td class="td-status">
									...
									<td class="f-14 td-manage">
										<a style="text-decoration:none" id="fly" onclick="flight_readyFly(this,'<s:property value="#flightInfo.flightId"/>')" href="javascript:;" title="重新发布"><i class="Hui-iconfont">&#xe642;</i></a>
